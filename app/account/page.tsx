    ...
    <div className="max-w-4xl mx-auto p-6 space-y-10">
      ...
      <div className="border p-4 rounded-xl">
        ...
        <select
          ...
          onChange={(e) =>
            setKyc({ ...kyc, document_type: e.target.value })
          }
        >
        ...
        {!kyc.is_international ? (
          <>
            <input
              ...
              value={kyc.bank_name || ""}
              onChange={(e) =>
                setKyc({ ...kyc, bank_name: e.target.value })
              }
            />
            ...
            <input
              ...
              onChange={(e) =>
                setKyc({ ...kyc, bank_account: e.target.value })
              }
            />
            ...
            <input
              ...
              onChange={(e) =>
                setKyc({ ...kyc, account_owner: e.target.value })
              }
            />
          </>
        ) : (
          <>
            <input
              ...
              value={kyc.iban || ""}
              onChange={(e) =>
                setKyc({ ...kyc, iban: e.target.value })
              }
            />
            ...
            <input
              ...
              value={kyc.swift || ""}
              onChange={(e) =>
                setKyc({ ...kyc, swift: e.target.value })
              }
            />
          </>
        )}
